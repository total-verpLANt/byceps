...
-- The retention purge (`byceps purge-lan-tournament-log-entries`) and its
-- --dry-run count both filter on occurred_at alone. Without this index
-- both statements sequentially scan the whole audit table.
